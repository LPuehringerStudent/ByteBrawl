...
public static class ByteMoveset
{
    public static Moveset Create()
    {
        ...
        var swordHeavy = new AttackData
        {
            ...
            Hitboxes = { new HitboxSpec { LimbChain = { "NearUpperArm", "NearForearm", "NearHand" }, RadiusScale = 1.1f } },
        ...
        var byteSpecial = new AttackData
        {
            ...
            Stages =
            {
                ...
                new AttackStage { Id = "byte-special-2", BaseDamage = 2, BaseKnockback = 55,
                    ...
                    Hitboxes =
                    {
                        new HitboxSpec { LimbChain = { "NearUpperArm", "NearForearm", "NearHand" }, NoKnockback = true },
                        new HitboxSpec { LimbChain = { "NearHand" }, RadiusScale = 0.75f, DamageOverride = 3, NoKnockback = true },
                    } },
                new AttackStage { Id = "byte-special-3", BaseDamage = 5, BaseKnockback = 180,
                    ...
                    Hitboxes =
                    {
                        new HitboxSpec { LimbChain = { "NearUpperArm", "NearForearm", "NearHand" }, RadiusScale = 1.1f },
                        new HitboxSpec { LimbChain = { "NearHand" }, RadiusScale = 0.75f, DamageOverride = 7, KnockbackOverride = 210 },
                    } },
            },
        };
